...
void h265_read_sps_rbsp2(unsigned char *nal, int nal_len, int *width, int *height, float *fps, H265_PROFILE_T* h265Profile)
{
    bs_t bs;
    bs_t *s = &bs;
...
*/
    ...
    if (h265Profile)
    {
        h265Profile->general_profile_space = profile_tier_level.general_profile_space;
        h265Profile->general_tier_flag = profile_tier_level.general_tier_flag;
        h265Profile->general_profile_idc = profile_tier_level.general_profile_idc;
        memcpy(h265Profile->general_profile_compatibility_flag, profile_tier_level.general_profile_compatibility_flag, sizeof(profile_tier_level.general_profile_compatibility_flag));
        h265Profile->general_progressive_source_flag = profile_tier_level.general_progressive_source_flag;
        h265Profile->general_interlaced_source_flag = profile_tier_level.general_interlaced_source_flag;
        h265Profile->general_non_packed_constraint_flag = profile_tier_level.general_non_packed_constraint_flag;
        h265Profile->general_frame_only_constraint_flag = profile_tier_level.general_frame_only_constraint_flag;
        h265Profile->general_max_12bit_constraint_flag = profile_tier_level.general_max_12bit_constraint_flag;
        h265Profile->general_max_10bit_constraint_flag = profile_tier_level.general_max_10bit_constraint_flag;
        h265Profile->general_max_8bit_constraint_flag = profile_tier_level.general_max_8bit_constraint_flag;


        h265Profile->general_max_422chroma_constraint_flag = profile_tier_level.general_max_422chroma_constraint_flag;
        h265Profile->general_max_420chroma_constraint_flag = profile_tier_level.general_max_420chroma_constraint_flag;
        h265Profile->general_max_monochrome_constraint_flag = profile_tier_level.general_max_monochrome_constraint_flag;
        h265Profile->general_intra_constraint_flag = profile_tier_level.general_intra_constraint_flag;
        h265Profile->general_one_picture_only_constraint_flag = profile_tier_level.general_one_picture_only_constraint_flag;

        h265Profile->general_lower_bit_rate_constraint_flag = profile_tier_level.general_lower_bit_rate_constraint_flag;
        h265Profile->general_reserved_zero_34bits = profile_tier_level.general_reserved_zero_34bits;
        h265Profile->general_reserved_zero_43bits = profile_tier_level.general_reserved_zero_43bits;
        h265Profile->general_inbld_flag = profile_tier_level.general_inbld_flag;
        h265Profile->general_reserved_zero_bit = profile_tier_level.general_reserved_zero_bit;
        h265Profile->general_level_idc = profile_tier_level.general_level_idc;
    }
